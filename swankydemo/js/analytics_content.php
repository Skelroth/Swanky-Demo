      ...
      <span><h2>Attendees ($attendeesin/$attendeesmax)</h2>
       <div id="progressbar" class="ui-progressbar ui-widget ui-widget-content ui-corner-all" role="progressbar" aria-valuemin="0" aria-valuemax="<?php $attendeesin ?>" aria-valuenow="<?php $attendeesin ?>"><div class="ui-progressbar-value ui-widget-header ui-corner-left ui-corner-right" style="width: 20%;"></div></div>
          ...
          <div class="box grid_6">
            ...
            <div class="box-content">
              <div id="flot-realtime" style="padding: 0px; position: relative;"><canvas class="base" width="859" height="300"></canvas><canvas class="overlay" width="859" height="300" style="position: absolute; left: 0px; top: 0px;"></canvas><div class="tickLabels" style="font-size:smaller"><div class="yAxis y1Axis" style="color:#545454"><div class="tickLabel" style="position:absolute;text-align:right;top:291px;right:841px;width:18px">0</div><div class="tickLabel" style="position:absolute;text-align:right;top:233px;right:841px;width:18px">20</div><div class="tickLabel" style="position:absolute;text-align:right;top:174px;right:841px;width:18px">40</div><div class="tickLabel" style="position:absolute;text-align:right;top:116px;right:841px;width:18px">60</div><div class="tickLabel" style="position:absolute;text-align:right;top:57px;right:841px;width:18px">80</div><div class="tickLabel" style="position:absolute;text-align:right;top:-1px;right:841px;width:18px">100</div></div></div></div>
            </div>
          </div>
      </div>
    </body>