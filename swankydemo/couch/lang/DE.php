<?php
	...
	$t['insufficient_privileges'] = 'Sie verf&uuml;gen nicht &uuml;ber die notwendigen Berechtigungen um die gew&uuml;schte Seite anzuzeigen. Um sie zu sehen, loggen Sie sich bitte aus und loggen Sie sich mit den notwendigen Berechtigungen wieder ein.';
	
	// Password recovery
	$t['recovery_prompt'] = 'Bitte geben Sie Ihren Benutzernamen oder Ihre E-Mail-Adresse ein, Sie werden dann Ihr Passwort per E-Mail erhalten.';
	...
	$t['select_folder'] = 'Ordner ausw&auml;hlen';
	$t['folders'] = 'Ordner';
	...
	$t['original_deleted'] = 'ORIGINAL GEL&Ouml;scht'; //in Caps
