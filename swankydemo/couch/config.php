<?php
    ...
    define( 'K_DB_NAME', 'Swanky' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'Swanky' );
    // 6.
    // Database password 
    define( 'K_DB_PASSWORD', 'Tworlds123!' );
    // 7.
    // MySQL hostname (it will usually be 'localhost' )
    define( 'K_DB_HOST', 'Swanky.db.11099833.hostedresource.com' );
    // 7b.
    ...
    define( 'K_DB_TABLES_PREFIX', 'SWANK_' );        
