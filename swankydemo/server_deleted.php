      ...
      <ul id="nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
           ...
           <a href="servers.php"><img src="img/nav/err-active.png" alt="" /><p>Servers</p></a>
...
if (($_SESSION['usr'] ? $_SESSION['usr'] : 'Guest') == 'Guest')
  ...
  {
  echo "<br></br><br></br> <h1 align=\"center\"> Log in to view this page :)</h1>";
  }
  ...
  include 'servers-list.php';

  include 'servers_add.php';
  echo "<div class=\"ad-notif-warn grid_12 small-mg\"><p style=\"float: left\">Server successfully deleted!!</p><p style=\"float: right\">(click to dismiss)</p></div>";
